...
- The checkout block moves to `modules/upsell-order-bump/src/blocks/` → `build/modules/upsell-order-bump/blocks.js`; the block name stays `storegrowth-upsell-order-bump`.
