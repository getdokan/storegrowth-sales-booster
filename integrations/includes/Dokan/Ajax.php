...
class Ajax {
    ...
    private function __construct() {
	    add_action( 'wp_ajax_sgsb_bogo_vendors_get_settings', [ $this, 'get_settings' ] );
        add_action( 'wp_ajax_sgsb_bogo_vendors_save_settings', [ $this, 'save_settings' ] );
    }
    ...
    public function save_settings() {
        ...
        if ( isset( $data['sgsb_bogo_dokan_vendors_settings_data'] ) ) {
