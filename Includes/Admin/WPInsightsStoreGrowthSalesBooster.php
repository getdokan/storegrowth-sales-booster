<?php
/**
 * WPInsights StoreGrowth Sales Booster
...
/**
 * Main SDK for WPInsightsStoreGrowthSalesBooster.
 */
if ( ! class_exists( 'WPInsightsStoreGrowthSalesBooster' ) ) :

	class WPInsightsStoreGrowthSalesBooster {
		...
		/**
		 * Instace of WPInsights_Storegrowth_sales-booster
		 *
		 * @var WPInsightsStoreGrowthSalesBooster
		 */
		private static $_instance = null;

		/**
		 * Get Instance of WPInsightsStoreGrowthSalesBooster
		 *
		 * @return WPInsightsStoreGrowthSalesBooster
		 */
