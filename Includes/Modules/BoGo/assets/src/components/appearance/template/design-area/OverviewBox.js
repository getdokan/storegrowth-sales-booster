...
function OverviewBox() {
  ...
  return (
    <div style={{ marginBottom: "10px" }}>
      <div className="offer-offer-box-text">Bump Offer Box</div>
      <Form.Item label="Overview Border" labelAlign="left">
        <Select
          placeholder="Change Overview Border"
          onChange={(v) => onFieldChange("box_border_style", v)}
          className="form-input-distance"
          value={createBogoData.box_border_style}
        >
      ...
      >
        <InputColor
          initialValue={createBogoData.box_border_color}
        ...
        <Row>
          <Col span={18}>
            <Slider
              ...
              value={createBogoData.box_top_margin}
            />
          </Col>
          <Col span={6}>{createBogoData.box_top_margin}px</Col>
        </Row>
      </Form.Item>
        ...
        <Row>
          <Col span={18}>
            <Slider
              ...
              value={createBogoData.box_bottom_margin}
            />
          </Col>
          <Col span={6}>{createBogoData.box_bottom_margin}px</Col>
        </Row>
      </Form.Item>
    </div>
  );
