        ...
        <?php if ( 'bogo-icons-2' === $offer_badge ) : ?>
            <svg width='16px' height='17px' viewBox='0 0 100 100'>
                <g>
                    ...
                    <path class="st0" d="M52.8,38.4H57v4.2c0,1.7,1.3,3,3,3s3-1.3,3-3v-4.2h4.2c1.7,0,3-1.3,3-3s-1.3-3-3-3H63v-4.2c0-1.7-1.3-3-3-3   s-3,1.3-3,3v4.2h-4.2c-1.7,0-3,1.3-3,3S51.1,38.4,52.8,38.4z" />
                </g>
            </svg>
        <?php endif; ?>
