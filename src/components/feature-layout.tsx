...
export function FeatureLayout( { moduleId, children }: FeatureLayoutProps ) {
    ...
    return (
        ...
        <div className="spsg-feature-layout flex w-full flex-col min-[901px]:min-h-[calc(100vh-var(--spsg-rail-top))] min-[901px]:flex-row">
            <FeatureMenu activeId={ moduleId } />
            <div className="mx-auto flex min-w-0 max-w-[min(1280px,100%)] flex-1 flex-col items-center p-4 wpsm:p-8 *:w-full">
