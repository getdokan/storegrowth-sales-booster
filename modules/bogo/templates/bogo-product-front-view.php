		...
		<div
            ...
            style="
                <?php
                    ...
                    $border_color = Helper::get_design_value( $bogo_info, 'box_border_color' );
                    $top_margin = Helper::get_design_value( $bogo_info, 'box_top_margin' );
                    $bottom_margin = Helper::get_design_value( $bogo_info, 'box_bottom_margin' );
            ...
            "
        >
			<div class="dynamic-offer-text" style="background: <?php echo esc_attr( Helper::get_design_value( $bogo_info, 'discount_background_color' ) ); ?>;
													color: <?php echo esc_attr( Helper::get_design_value( $bogo_info, 'discount_text_color' ) ); ?>;
													font-size: <?php echo esc_attr( Helper::get_design_value( $bogo_info, 'discount_font_size' ) ); ?>px;">
				<svg width='15' height='15' viewBox='0 0 12 12' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    <path
						fill='<?php echo esc_attr( Helper::get_design_value( $bogo_info, 'discount_text_color' ) ); ?>'
				...
				<?php echo esc_attr( $bogo_message ); ?>
			</div>
			<div class="product-image-and-title">
				<div class="offer-product-image-title">
					...
					<div class="offer-product-title" style="color: <?php echo esc_attr( Helper::get_design_value( $bogo_info, 'product_description_text_color' ) ); ?>;
															font-size: <?php echo esc_attr( Helper::get_design_value( $bogo_info, 'product_description_font_size' ) ); ?>px;">
						<h3 style="color: <?php echo esc_attr( Helper::get_design_value( $bogo_info, 'product_description_text_color' ) ); ?>">
						...
						<?php if ( ! empty( $category_names ) ) : ?>
							<p style="color: <?php echo esc_attr( Helper::get_design_value( $bogo_info, 'product_description_text_color' ) ); ?>">
				...
				<div
                    class="offer-price"
                    style="
                        color: <?php echo esc_attr( Helper::get_design_value( $bogo_info, 'product_description_text_color' ) ); ?>;
                        font-size: <?php echo esc_attr( Helper::get_design_value( $bogo_info, 'product_description_font_size' ) ); ?>px;
                    "
                >
