...
class EnqueueScript implements HookRegistry {
	...
	public function wp_enqueue_scripts() {
		wp_enqueue_style(
			'sgsb-button-style',
			PluginHelper::get_modules_url( 'direct-checkout/assets/css/sgsb-dc-style.css' ),
			array(),
			filemtime( PluginHelper::get_modules_path( 'direct-checkout/assets/css/sgsb-dc-style.css' ) )
		);
		...
		wp_enqueue_script(
			'sgsb-dc-script',
			PluginHelper::get_modules_url( 'direct-checkout/assets/js/sgsb-dc-script.js' ),
			array( 'jquery' ),
			filemtime( PluginHelper::get_modules_path( 'direct-checkout/assets/js/sgsb-dc-script.js' ) ),
			true
		);
