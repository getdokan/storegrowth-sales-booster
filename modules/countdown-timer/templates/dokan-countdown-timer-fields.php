...
$settings = get_option('sgsb_countdown_timer_settings', array());
...
$defaults = apply_filters('sgsb_countdown_timer_fields_defaults', $defaults);
...
$discount_amount = get_post_meta($post_id,'_sgsb_countdown_timer_discount_amount', true);
$dates_from = get_post_meta($post_id, '_sgsb_countdown_timer_discount_start', true);
$dates_to   = get_post_meta($post_id, '_sgsb_countdown_timer_discount_end', true);
