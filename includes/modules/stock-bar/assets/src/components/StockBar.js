  ...
  return (
    <Card>
      ...
      >
        ...
        <Form.Item label="Foreground Color" labelAlign="left">
          ...
          <div style={isProStyle}>
            <InputNumber
              ...
              onChange={
                sgsbAdmin.isPro
                  ? (v) =>
                      isProFieldChange(sgsbAdmin.isPro, "stockbar_height", v)
                  : ""
              }
              style={{ width: 100 }}
            />
        ...
        <Form.Item label="Stock Display Format" labelAlign="left">
          <div style={isProStyle}>
            <Select
              disabled={!sgsbAdmin.isPro}
        ...
        <Form.Item label="Display on Product Page" labelAlign="left">
          <Space direction="vertical">
            <Checkbox
              ...
              onChange={(e) =>
                onFieldChange("product_page_stock_bar_enable", e.target.checked)
              }
            ></Checkbox>
          </Space>
        </Form.Item>
