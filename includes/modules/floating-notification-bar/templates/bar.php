	...
	<div class="sgsb-floating-notification-bar">
		<div class='sgsb-floating-notification-bar-icon'>
			...
			<?php if ( 'notify-bar-icon-2' === $banner_icon ) : ?>
				...
				>
					<g>
						<path d='M82.9,90.7c-3.6-3.6-3.6-9.5,0-13.2c3.6-3.6,9.5-3.6,13.2,0c3.6,3.6,3.6,9.5,0,13.2C92.4,94.3,86.5,94.3,82.9,90.7z'/>
