...
$bar_height          = sbfw_find_option_setting( $settings, 'progressbar_height', '5' );
$bg_color            = sbfw_find_option_setting( $settings, 'progressbar_bg_color', '#444444' );
$fg_color            = sbfw_find_option_setting( $settings, 'progressbar_fg_color', '#c3d168' );
$sd_format           = sbfw_find_option_setting( $settings, 'stock_display_format', 'above' );
$total_sell_text     = sbfw_find_option_setting( $settings, 'total_sell_count_text', 'Total Sold' );
$available_item_text = sbfw_find_option_setting( $settings, 'available_item_count_text', 'Available Item' );
?>
<div
	class="sbfw-stock-progress-bar wpbsc_total_sale sbfw-stock-progress-bar-format-<?php echo esc_attr( $sd_format ); ?>"
...
>
	...
	<div class="sbfw-stock-progressbar-status">
