...
$dates_from = get_post_meta( $product_object->get_id(), '_storepulse_sales_booster_stock_countdown_discount_start', true );
$dates_to   = get_post_meta( $product_object->get_id(), '_storepulse_sales_booster_stock_countdown_discount_end', true );

?>
<div id="storepulse_sales_booster-stock-countdown-tab" class="panel woocommerce_options_panel hidden">
