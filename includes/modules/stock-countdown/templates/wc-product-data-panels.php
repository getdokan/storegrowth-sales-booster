...
$dates_from = gmdate( 'Y-m-d', strtotime( $dates_from ) );
$dates_to   = gmdate( 'Y-m-d', strtotime( $dates_to ) );
	...
	<div class="options_group">
		<?php
			woocommerce_wp_text_input(
				array(
					'id'          => '_sgsb_stock_countdown_discount_amount',
		...
		<p class="form-field sale_price_dates_fields" style="margin-bottom: 0;">
			...
			<input type="text" class="short" name="_sgsb_stock_countdown_discount_start" id="_sgsb_stock_countdown_discount_start" value="<?php echo esc_attr( $dates_from ); ?>" placeholder="Start&hellip; YYYY-MM-DD" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" />
			<input type="text" class="short" name="_sgsb_stock_countdown_discount_end" id="_sgsb_stock_countdown_discount_end" value="<?php echo esc_attr( $dates_to ); ?>" placeholder="End&hellip; YYYY-MM-DD" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" />
			...
			<input type="hidden" value="sgsb_stock_countdown_dates_fields">
		</p>
