...
<div id="sgsb-countdown-timer-tab" class="panel woocommerce_options_panel hidden">
	<div class="options_group">
		...
		<p class="form-field sale_price_dates_fields" style="margin-bottom: 0;">
			...
			<input type="text" class="short" name="_sgsb_countdown_timer_discount_start" id="_sgsb_countdown_timer_discount_start" value="<?php echo esc_attr( $dates_from ); ?>" placeholder="Start&hellip; YYYY-MM-DD" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" />
			<input type="text" class="short" name="_sgsb_countdown_timer_discount_end" id="_sgsb_countdown_timer_discount_end" value="<?php echo esc_attr( $dates_to ); ?>" placeholder="End&hellip; YYYY-MM-DD" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" />
