...
function GenenralSettings({ formData, onFieldChange, onFormSave, buttonLoading }) {
 ...
 * Design Settings Tab
 */
function DesignSettings({ formData, onFieldChange, onFormSave, buttonLoading }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Select.Option value="flaticon-shopping-cart">flaticon-shopping-cart</Select.Option>
          <Select.Option value="flaticon-shopping-cart-1">flaticon-shopping-cart-1</Select.Option>
          <Select.Option value="flaticon-shopping-cart-2">flaticon-shopping-cart-2</Select.Option>
          <Select.Option value="flaticon-shopping-cart-3">flaticon-shopping-cart-3</Select.Option>
          <Select.Option value="flaticon-shopping-cart-4">flaticon-shopping-cart-4</Select.Option>
          <Select.Option value="flaticon-cart">flaticon-cart</Select.Option>
          <Select.Option value="flaticon-shopping-bag">flaticon-shopping-bag</Select.Option>
          <Select.Option value="flaticon-shopping-bag-1">flaticon-shopping-bag-1</Select.Option>
          <Select.Option value="flaticon-shopping-bag-2">flaticon-shopping-bag-2</Select.Option>
        </Select>
      </Form.Item>
      ...
      <Button type="primary" onClick={()=>onFormSave('design')} loading={buttonLoading}>Save Changes</Button>
    </Form>
  );
}
