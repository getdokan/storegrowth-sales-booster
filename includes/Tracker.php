...
class Tracker {
    ...
    public function get_custom_deactivation_reasons( $reasons, $client = null ) {
        ...
        // return if client is not storegrowth-sales-booster
        if ( 'storegrowth-sales-booster' !== $client->slug ) {
            return $reasons;
        }
        ...
        return [
            ...
            [
                'id'          => 'upgrading-to-storegrowth-sales-booster-pro',
                'text'        => 'I’m Upgrading to StoreGrowth Pro ',
                'placeholder' => 'Great! But don’t be hasty to deactivate. To run StoreGrowth Pro versions, you require the StoreGrowth Lite plugin. It’s a must!',
            ...
            [
                ...
                'placeholder' => 'Sorry to see you go. If you ever have the need to use StoreGrowth again, please return without hesitation. And we’re always by your side to help.',
