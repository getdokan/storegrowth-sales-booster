...
/**
 * Main SDK for WPInsights_Storegrowth_sales-booster.
 */
if( ! class_exists('WPInsights_Storegrowth_Sales_booster') ) :
	class WPInsights_Storegrowth_Sales_booster {
		/**
		 * WP Insights Version
		 */
		 ...
		 * @var WPInsights_Storegrowth_sales-booster
		 */
		private static $_instance = null;
		/**
		 * Get Instance of WPInsights_Storegrowth_sales-booster
		 * @return WPInsights_Storegrowth_sales-booster
		 */
