...
if ( ! function_exists( 'storegrowth_sales_booster_start_plugin_tracking' ) ) {
	...
	function storegrowth_sales_booster_start_plugin_tracking() {
		if ( ! class_exists( 'WPInsights_Storegrowth_Sales_Booster' ) ) {
			require_once __DIR__ . '/admin/class-wpinsights-storegrowth-sales-booster.php';
		}
		$tracker = WPInsights_Storegrowth_Sales_Booster::get_instance(
			STOREGROWTH_PLUGIN_DIR_PATH,
			array(
				'opt_in'       => true,
				'goodbye_form' => true,
